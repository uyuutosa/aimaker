...
class BaseDataset(data.Dataset):
    ...
    def getTransforms(self):
        self.input_transform = self.ch.getInputTransform(self.mode)
        self.target_transform = self.ch.getTargetTransform(self.mode)
        self.common_transform = self.ch.getCommonTransform(self.mode)
