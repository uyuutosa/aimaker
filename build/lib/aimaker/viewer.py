...
class TrainMonitor:
    def __init__(self, setting):
        ...
        self.loss_tags = self.ch.getVisdomGraphTags()
...
class VisdomViewer:
    def __init__(self, setting):
        self.ch = SettingHandler(setting)
        portNumber = self.ch.getVisdomPortNumber()
        ...
        self.graph_taglst = self.ch.getVisdomGraphTags()
        self.graph_xlabel_dic = self.ch.getVisdomGraphxlabels()
        self.graph_ylabel_dic = self.ch.getVisdomGraphylabels()
        self.graph_title_dic = self.ch.getVisdomGraphtitles()
        self.image_taglst = self.ch.getVisdomImageTags()
        self.image_title_dic = self.ch.getVisdomImageTitles()
