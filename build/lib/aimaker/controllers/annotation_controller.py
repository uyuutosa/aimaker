...
class AnnotationController:
    ...
    def forward(self):
        ...
        self.generator_loss = self._calcGeneratorLoss((self.out1, self.out2, self.out3, self.out4, self.fake), self.target)
        self.discriminator_loss = self._calcDiscriminatorLoss(self.real, self.fake, self.target)
    ...
    def _calcGeneratorLoss(self, outputs, target):
    ...
    def _calcDiscriminatorLoss(self, real, fake, target):
