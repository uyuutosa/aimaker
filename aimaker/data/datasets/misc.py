...
class DatasetOfBGForAutomaticAnnotation(BaseDataset):
    ...
    def setMode(self, mode):
        self.ds_front_image.set_mode(mode)
        self.ds_side_image.set_mode(mode)
        self.ds_input_features.set_mode(mode)
        self.ds_gt_size.set_mode(mode)
        self.ds_gt_ann_front.set_mode(mode)
        self.ds_gt_ann_side.set_mode(mode)
...
class DatasetOfBGForAutomaticAnnotation3(BaseDataset):
    ...
    def setMode(self, mode):
        self.ds_front_image.set_mode(mode)
        self.ds_front_map.set_mode(mode)
...
class DatasetOfBGForSideImages(BaseDataset):
    ...
    def setMode(self, mode):
        self.ds_side_image.set_mode(mode)
        self.ds_side_map.set_mode(mode)
